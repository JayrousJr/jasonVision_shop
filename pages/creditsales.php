...
<div class="row">
   <div class="col-md-4">
  <?php
        $result = mysqli_query($conn,"SELECT sum(total) FROM credit") or die(mysqli_error());
        while ($rows = mysqli_fetch_array($result)) {
    ?>
    <div class="pull-right">
        <div class="span">
            <div class="alert alert-info">
    <i class="icon-credit-card icon-sm"></i>&nbsp;<b>Total Credit Sales</b>:&nbsp;<?php echo $rows['sum(total)']; ?>
        </div>
        </div>
    </div>
    <?php } ?>
...
<center><p><b><font size="5">Credit Sales</font></b></p></center>
<form method="POST">
  <div class="col-md-offset-9">
  <input type="submit" name="send" class="btn btn-danger" value="Delete All Credit Sales"><br>
  <?php
   if (isset($_POST['send'])){
...
{
   echo("No data have been deleted.");
}
  ...
  ?>
              ...
              <a href='sendsales.php?sales_id=$id' class='button'><input type='button' class='btn btn-danger' value='Confirm Payment'></a></td>";?>
                                 </tr>
                  ...
                  <!--modal of edit start-->
<div class="modal fade" id="exae" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <div class="col-md-12">
              ...
              <div class="row">
                ...
                <input type="number" name="total" class="form-control" id="total">
                   ...
                   <div class=" col-md-3">
                <label>Sold_By</label>
                <input type="text" name="soldby" class="form-control" id="soldby">
              </div>
               <div class=" col-md-3">
       ...
       <div class="row">
        ...
        <input type="button" name="submit" id="submit" onclick="updateDet()" value="Save Changes" class="btn btn-primary"/>
...
<!--modal end-->
      ...
      function updateDet(){
        ...
        $.ajax({
          ...
          method:'POST',
          dataType:'text',
        data:{key:'update',editId:id,drug_name:drug_name,quantity:quantity,price:price,total:total,soldby:soldby,sale_date:sale_date},
          success: function(userdata){
            //console.log(userdata);
