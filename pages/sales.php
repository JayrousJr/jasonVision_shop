...
if (isset($_GET['shop'])) {
  if ($role != 'employee') {
    $data = $db->get_all('sales', array('shop_id', $shop_id));
  } else {
    $start = date('Y-m-01');
    $end = date('Y-m-d') . ' 23:59:59.999';
    $data = $db->get_all('sales', "sale_date BETWEEN '$start' AND '$end' AND shop_id = '" . $shop_id . "'");
  }
}
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well">
                                <h2><i class="fa fa-bar-chart"></i> Sales Transactions</h2>
                            ...
                            <div class="box-content">
                                ...
                                <div class="app-bar" style="display: flex; justify-content: space-between;">
                                    <form class="form-inline" method="POST" action="?shop=<?= $_GET['shop'] ?>">
                                        ...
                                        <a href="?shop=<?= $_GET['shop'] ?>" class="btn btn-default">
                                ...
                                <table class="table table-striped table-bordered table-sm datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($perms->is_admin()) : ?>
                                            <td>
                                                <a href="#" onclick="update_sale(<?= $row->id ?>)"
                                                    class="btn btn-success btn-sm">
                                                    edit
                                                </a>
                                                <a href="includes/delete.inc.php?del=sale&id=<?= $row->id ?>"
