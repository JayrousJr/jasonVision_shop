 	...
 	function Header()
 	{
       ...
       // $this ->Image('img/tb.jpg',10,10,10);
        ...
        $this ->SetFont('Times','',12);
 	    $this ->Cell(176,10,'Loan Report',0,0,'C');
 	    $this ->Ln(20);
 	    ...
 	    $this ->Cell(50,5,'Name/Organization',1,0,11,true);
 	    $this ->Cell(30,5,'Starting Date ',1,0,11,true);
...
while ($data=mysqli_fetch_array($query)) {
	    ...
	    $pdf ->Cell(30,5,$data['dat'],1,0);
 	    $pdf ->Cell(50,5,$data['oname'],1,0);
 	    $pdf ->Cell(30,5,$data['sdate'],1,0);
 	    $pdf ->Cell(30,5,$data['exdate'],1,0);
 	    $pdf ->Cell(30,5,$data['amount'],1,0);
