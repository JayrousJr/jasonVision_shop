 	...
 	{
	{
       // $this ->Image('img/tb.jpg',10,10,10);
        ...
        $this ->SetFont('Times','',12);
 	    $this ->Cell(176,10,'Licence Report',0,0,'C');
 	    $this ->Ln(20);
 	    ...
 	    $this ->Cell(35,5,'Amount',1,0,11,true);
...
$query=mysqli_query($con,"SELECT * FROM license");
while ($data=mysqli_fetch_array($query)) {

	 
	    $pdf ->Cell(30,5,$data['dat'],1,0);
 	    $pdf ->Cell(30,5,$data['daty'],1,0);
 	    $pdf ->Cell(30,5,$data['datz'],1,0);
 	    $pdf ->Cell(35,5,$data['amount'],1,0);
