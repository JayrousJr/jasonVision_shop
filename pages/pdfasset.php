...
include 'includes/dbh.php';
 ...
 class PDF extends FPDF
 {
  ...
  //      $this ->Cell(276,5,'Asset Report',0,0,'C');
  //       $this ->Ln();
  //       $this ->SetFont('Times','',12);
 	//     $this ->Cell(276,10,'Jason Vision',0,0,'C');
 	//     $this ->Ln(20);
 	...
 	// }
       ...
       // $this ->Image('img/tb.jpg',10,10,10);
        ...
        $this ->Ln();
        $this ->SetFont('Times','',12);
 	    $this ->Cell(276,10,'Asset Report',0,0,'C');
 	    $this ->Ln(20);
 	    ...
 	    $this ->Cell(30,5,'Description/Year',1,0,11,true);
